...
#
$execute store success score #resource_remove_success resource_test run execute if score #$(type) material matches $(amount).. run scoreboard players remove #$(type) material $(amount)
