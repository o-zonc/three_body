...
execute if data storage three_body:resource.input amount run tellraw @s [{"text":"다음 업그레이드 비용: ","color":"gray"},{"nbt":"amount","storage":"three_body:resource.input","color":"yellow"},{"text":" wood","color":"green"}]
