...
execute store result score #emerald_regen_max tmp run data get storage three_body:resource.config.emerald.regen
...
execute if score #emerald_regen_lvl_next tmp >= #emerald_regen_max tmp run return 0
