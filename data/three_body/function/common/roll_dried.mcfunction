...
execute unless score #GLOBAL state_dried matches 2 if score #ROLL roll_chance matches 0..2 run scoreboard players set #GLOBAL timer_dried 6000
execute unless score #GLOBAL state_dried matches 2 if score #ROLL roll_chance matches 0..2 run bossbar set three_body:bossbar_dried max 6000
...
execute unless score #GLOBAL state_dried matches 2 if score #ROLL roll_chance matches 51..99 run scoreboard players set #GLOBAL timer_dried 6000
execute unless score #GLOBAL state_dried matches 2 if score #ROLL roll_chance matches 51..99 run bossbar set three_body:bossbar_dried max 6000