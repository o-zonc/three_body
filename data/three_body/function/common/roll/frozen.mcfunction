...
execute if score #GLOBAL state_frozen matches 1 if score #ROLL_EXTREME roll_chance matches 98..99 run advancement grant @a only three_body:1_frozen/01_chaotic
...
execute unless score #GLOBAL state_frozen matches 2 if score #ROLL roll_chance matches 0..19 run bossbar set three_body:bossbar_frozen max 400
...
execute unless score #GLOBAL state_frozen matches 2 if score #ROLL roll_chance matches 20..39 run bossbar set three_body:bossbar_frozen max 800
...
execute unless score #GLOBAL state_frozen matches 2 if score #ROLL roll_chance matches 40..59 run bossbar set three_body:bossbar_frozen max 1200
...
execute unless score #GLOBAL state_frozen matches 2 if score #ROLL roll_chance matches 60..79 run bossbar set three_body:bossbar_frozen max 1600
...
execute unless score #GLOBAL state_frozen matches 2 if score #ROLL roll_chance matches 80..99 run bossbar set three_body:bossbar_frozen max 400