...
# [난세기 중 멸망: 15% (0~14)]
execute if score #GLOBAL state_dried matches 1 if score #ROLL_EXTREME roll_chance matches 0..14 run tellraw @a[nbt={Dimension:"three_body:dried"}] [{"text":"[메마른 세계] 난세기 중 멸망!","color":"#a05500"}]
