...
execute unless entity @a[tag=accelerator_experiment_running] unless score #shield_taken tmp matches 1 run title @s actionbar {text:"일반 양자 얽힘 파편이 없습니다.",color:"red",italic:true}
