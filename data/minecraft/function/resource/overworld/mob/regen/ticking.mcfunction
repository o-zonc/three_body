...
execute positioned 3.5 1.9375 4.5 unless entity @e[tag=mob,tag=!blaze,distance=..0.2,type=item_display] unless score #mob_remain generate = #mob_remain generate run function resource/overworld/mob/regen/summon

execute if score #mob_remain generate matches ..0 run function resource/overworld/mob/regen/summon
