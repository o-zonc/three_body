...
execute unless score #overworld civilization_age matches 4.. run title @s actionbar "§c철기 시대에 도달해야 합니다."
...
execute unless score #emerald_unlock_cost_check tmp matches 1 run title @s actionbar "§c재료가 부족합니다."
