...
execute unless score #overworld civilization_age matches 3.. run title @s actionbar {text:"청동기 시대에 도달해야 합니다.",color:"red",italic:true}
...
execute unless score #iron_unlock_cost_check tmp matches 1 run title @s actionbar {text:"재료가 부족합니다.",color:"red",italic:true}
