...
execute unless entity @a[tag=accelerator_experiment_running] unless score #coal_unlock_cost_check tmp matches 1 run title @s actionbar {text:"재료가 부족합니다.",color:"red",italic:true}
