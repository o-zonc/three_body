execute unless score #iron unlock matches 1 run function resource/effect/failure
...
execute store result storage data tmp.resource.upgrade.lvl int 1 run scoreboard players get #iron_regen_lvl upgrade
data modify storage data tmp.resource.upgrade.id set value "iron"
data modify storage data tmp.resource.upgrade.x set value 1.5
