...
function util/blank
tellraw @s ["",{text:"  [ 자원 상점 2층 - 생산 강화 ]",color:"gold",bold:true},{text:"\n\n  • 열기 자연 지급: ",color:"red",bold:false},{score:{name:"#second_heat_interval",objective:"tmp"},color:"white"},{text:"틱  (Lv. ",color:"gray"},{score:{name:"#second_heat_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n  • 냉기 자연 지급: ",color:"aqua"},{score:{name:"#second_cold_interval",objective:"tmp"},color:"white"},{text:"틱  (Lv. ",color:"gray"},{score:{name:"#second_cold_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n  • 금 기본 생산량: +",color:"gold"},{score:{name:"#second_gold_bonus",objective:"tmp"},color:"white"},{text:"  (Lv. ",color:"gray"},{score:{name:"#second_gold_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n  • 다이아몬드 기본 생산량: +",color:"aqua"},{score:{name:"#second_diamond_bonus",objective:"tmp"},color:"white"},{text:"  (Lv. ",color:"gray"},{score:{name:"#second_diamond_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n  • 열기·냉기 수급량: +",color:"light_purple"},{score:{name:"#second_special_bonus",objective:"tmp"},color:"white"},{text:"  (Lv. ",color:"gray"},{score:{name:"#second_special_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n  • 공통 기본 생산량: +",color:"green"},{score:{name:"#second_get_bonus",objective:"tmp"},color:"white"},{text:"  (Lv. ",color:"gray"},{score:{name:"#second_get_lvl",objective:"tmp"},color:"white"},{text:")",color:"gray"},{text:"\n\n  공통 보너스는 1층 상점 배수보다 먼저 적용됩니다.",color:"dark_gray",italic:true},{text:"\n"}]
