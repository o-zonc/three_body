...
$execute unless score #$(unlock) unlock matches 1 run title @s actionbar {text:"해금되지 않은 자원입니다.",color:"red"}
...
execute unless score #material_shop_cost_check tmp matches 1 run title @s actionbar {text:"재료가 부족합니다.",color:"red"}
