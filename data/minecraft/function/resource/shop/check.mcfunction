...
execute store result score #emerald_shop_value tmp run function resource/material/emerald/cooldown
execute store result score #lapis_shop_value tmp run function resource/material/lapis/cooldown
...
execute if score #copper unlock matches 1 run data modify storage data tmp.resource_shop.lines append value {text:"  • 구리",color:"gold",extra:[{text:"  수급량 ",color:"gray"},{score:{name:"#copper_shop_value",objective:"tmp"},color:"white"},{text:"배  (Lv. ",color:"gray"},{score:{name:"#copper_lvl",objective:"material_shop"},color:"white"},{text:")\n",color:"gray"}],bold:false}
...
execute if score #emerald unlock matches 1 run data modify storage data tmp.resource_shop.lines append value {text:"  • 에메랄드",color:"green",extra:[{text:"  재생산 대기 ",color:"gray"},{score:{name:"#emerald_shop_value",objective:"tmp"},color:"white"},{text:"틱  (Lv. ",color:"gray"},{score:{name:"#emerald_lvl",objective:"material_shop"},color:"white"},{text:")\n",color:"gray"}],bold:false}
...
execute if score #lapis unlock matches 1 run data modify storage data tmp.resource_shop.lines append value {text:"  • 청금석",color:"blue",extra:[{text:"  재생산 대기 ",color:"gray"},{score:{name:"#lapis_shop_value",objective:"tmp"},color:"white"},{text:"틱  (Lv. ",color:"gray"},{score:{name:"#lapis_lvl",objective:"material_shop"},color:"white"},{text:")\n",color:"gray"}],bold:false}
