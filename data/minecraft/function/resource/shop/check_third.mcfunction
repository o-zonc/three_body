...
execute if score #information_bank_unlocked meta matches 1.. run data modify storage data tmp.third_information_bank_limit set value {text:" / ∞조각",color:"gold"}
execute if score #time_bank_unlocked meta matches 1.. run data modify storage data tmp.third_time_bank_limit set value {text:" / ∞조각",color:"gold"}
