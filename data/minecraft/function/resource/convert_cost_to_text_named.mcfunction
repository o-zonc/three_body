...
$execute if score #cost_$(id)_diamond cost matches 1.. run data modify storage data tmp.cost_text.$(id).cost append value { text: "다이아몬드 ", color:aqua, shadow_color:-16777216, extra: [{score:{name:"#cost_$(id)_diamond",objective:"cost"}}, "개"] }
...
$execute if score #cost_$(id)_information cost matches 1.. run data modify storage data tmp.cost_text.$(id).cost append value { text: "정보 ", color:light_purple, shadow_color:-16777216, extra: [{score:{name:"#cost_$(id)_information",objective:"cost"}}, "개"] }
$execute if score #cost_$(id)_time cost matches 1.. run data modify storage data tmp.cost_text.$(id).cost append value { text: "시간 ", color:dark_aqua, shadow_color:-16777216, extra: [{score:{name:"#cost_$(id)_time",objective:"cost"}}, "개"] }
$execute if score #cost_$(id)_world_eye cost matches 1.. run data modify storage data tmp.cost_text.$(id).cost append value { text: "세계의 눈 ", color:dark_purple, shadow_color:-16777216, extra: [{score:{name:"#cost_$(id)_world_eye",objective:"cost"}}, "개"] }
