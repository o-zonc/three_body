...
execute unless score #time_bank_unlocked meta matches 1.. if score #time_bank_visible tmp matches 501.. run scoreboard players set #time_bank_visible tmp 500
data modify storage data tmp.time_bank_limit set value {text:" / 500조각",color:"gray"}
