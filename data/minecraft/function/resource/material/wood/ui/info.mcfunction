...
execute unless score #wood_gain tmp = #wood_base_gain tmp run data modify storage data tmp.advancement_reward_ui.wood set value [{text:" → "}, {score:{name:"#wood_gain",objective:"tmp"},color:"green"},{text:"§7개"},{"text":" ★", "hover_event":{"action":"show_text", "value":[{text:"§a최종 자원 수급량§r§7이 증가합니다.\n\n자원 상점 강화: §a수급량 ×"},{storage:"data",nbt:"tmp.resource_shop.wood.now.value",color:"green",plain:true}]}, "color":"green"}]
execute if score #wood_advancement_reward var matches 1 unless score #overworld_advancement_reward_disabled var matches 1 run data modify storage data tmp.advancement_reward_ui.wood set value [{text:" → "}, {score:{name:"#wood_gain",objective:"tmp"},color:"green"},{text:"§7개"},{"text":" ★", "hover_event":{"action":"show_text", "value":[{text:"§6기초 자원 수급량§r§7과 §a최종 자원 수급량§r§7이 증가합니다.\n\n발전과제 보상: §6수급량 ×3\n§r§7자원 상점 강화: §a수급량 ×"},{storage:"data",nbt:"tmp.resource_shop.wood.now.value",color:"green",plain:true}]}, "color":"green"}]
