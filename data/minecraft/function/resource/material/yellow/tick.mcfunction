...
execute unless score #yellow unlock matches 1 in minecraft:overworld run setblock -35 -62 -2 air replace
execute unless score #yellow unlock matches 1 run scoreboard players reset #yellow_remain generate
execute unless score #yellow unlock matches 1 run scoreboard players set #yellow_automated_harvest var 0
