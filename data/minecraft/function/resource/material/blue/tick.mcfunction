...
execute unless score #GLOBAL era_paused matches 1 if score #time_machine_ever_blue var matches 1 in minecraft:overworld run function resource/color/auto_mine {id:"blue",block:"blue_glazed_terracotta",x:-35,y:-62,z:2}
