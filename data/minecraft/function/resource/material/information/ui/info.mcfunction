...
execute unless score #information_bank_unlocked meta matches 1.. if score #information_bank_visible tmp matches 2001.. run scoreboard players set #information_bank_visible tmp 2000
