...
scoreboard players operation #material_add_limit tmp -= #quartz material
execute if score #material_add_limit tmp matches ..0 run scoreboard players operation #quartz material = #material_max tmp
...
scoreboard players operation #quartz material += #material_add_value tmp