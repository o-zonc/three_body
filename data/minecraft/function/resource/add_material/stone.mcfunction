...
scoreboard players operation #material_add_limit tmp -= #stone material
execute if score #material_add_limit tmp matches ..0 run scoreboard players operation #stone material = #material_max tmp
...
scoreboard players operation #stone material += #material_add_value tmp