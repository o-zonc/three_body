...
scoreboard players operation #material_add_limit tmp -= #obsidian material
execute if score #material_add_limit tmp matches ..0 run scoreboard players operation #obsidian material = #material_max tmp
...
scoreboard players operation #obsidian material += #material_add_value tmp