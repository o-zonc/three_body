...
execute if score #time_machine_yellow upgrade > #time_machine_blue upgrade run scoreboard players add #time_machine_path_yellow var 1
execute if score #time_machine_blue upgrade > #time_machine_yellow upgrade run scoreboard players add #time_machine_path_blue var 1
execute if score #time_machine_yellow upgrade = #time_machine_blue upgrade run scoreboard players add #time_machine_path_green var 1
execute if score #time_machine_yellow upgrade = #time_machine_blue upgrade run scoreboard players set #time_machine_green_discovered var 1
