...
# 첫 100개의 보상: min(보유량, 1000) / 20
scoreboard players operation #reckoning_time_resource_initial tmp = #reckoning_time_resource_amount tmp
execute if score #reckoning_time_resource_initial tmp matches 1001.. run scoreboard players set #reckoning_time_resource_initial tmp 1000
