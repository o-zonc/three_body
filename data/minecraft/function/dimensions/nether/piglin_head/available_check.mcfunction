...
execute if score #piglin_shop_lvl piglin_head matches 2.. unless score #stop_stone piglin_head matches 1 if block -3 -59 35 minecraft:stone run scoreboard players set #piglin_head_available tmp 1
