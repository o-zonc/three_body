...
execute store result score #piglin_shop_upgrade_cost_check tmp run function product/check_cost

execute if score #piglin_shop_upgrade_cost_check tmp matches 1 run function product/take_upgrade_cost
