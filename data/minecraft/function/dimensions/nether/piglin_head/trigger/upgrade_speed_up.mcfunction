execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_piglin_speed trial matches 1 run function trial/creation/lost
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_piglin_speed trial matches 1 run return 0
...
execute store result score #piglin_head_speed_up_upgrade_cost_check tmp run function product/check_cost

execute if score #piglin_head_speed_up_upgrade_cost_check tmp matches 1 run function product/take_upgrade_cost
