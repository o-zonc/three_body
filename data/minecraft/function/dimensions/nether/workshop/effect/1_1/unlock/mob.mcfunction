...
execute if score #1_1_cost_check tmp matches 1 run scoreboard players set #mob unlock 1
execute if score #1_1_cost_check tmp matches 1 run title @a[tag=player] actionbar "§6🍀 §3§l아차원 초월§7: 몹 자동 해금"
...
execute if score #1_1_cost_check tmp matches 1 run function resource/overworld/mob/regen/summon