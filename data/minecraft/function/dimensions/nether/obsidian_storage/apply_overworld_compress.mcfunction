...
execute if score #stone unlock matches 1 run function product/overworld/stone/regen/place
execute if score #mob unlock matches 1 run function product/overworld/mob/regen/summon
...
execute if score #cave unlock matches 1 store result score #coal_remain generate run function product/overworld/coal/value/regen_value
...
execute if score #cave unlock matches 1 store result score #iron_remain generate run function product/overworld/iron/value/regen_value
