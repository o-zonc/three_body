...
execute if score #cave_unlock_cost_check tmp matches 1 store result score #coal_remain generate run function resource/overworld/coal/value/regen_value
...
execute if score #cave_unlock_cost_check tmp matches 1 store result score #iron_remain generate run function resource/overworld/iron/value/regen_value
