execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_cave trial matches 1 run function trial/creation/lost
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_cave trial matches 1 run return 0
...
# 업그레이드 재료 소지 여부 확인
execute store result score #cave_unlock_cost_check tmp run function product/check_cost

# 소지 시 해금
execute if score #cave_unlock_cost_check tmp matches 1 run function product/take_cost
...
execute if score #cave_unlock_cost_check tmp matches 1 store result score #coal_remain generate run function product/overworld/coal/value/regen_value
...
execute if score #cave_unlock_cost_check tmp matches 1 store result score #iron_remain generate run function product/overworld/iron/value/regen_value
