...
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 if score #creation_poss_1 trial matches 1 run attribute @s minecraft:block_break_speed modifier add dim_comp:creation_poss_dig_speed 1000 add_multiplied_total
