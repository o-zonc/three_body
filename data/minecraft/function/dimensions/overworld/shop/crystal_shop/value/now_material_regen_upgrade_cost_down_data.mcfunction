# 현재 material_regen_upgrade_cost_down 상점 업그레이드 데이터를 tmp.crystal_shop.material_regen_upgrade_cost_down.now에 저장
...
execute store result storage data tmp.crystal_shop.material_regen_upgrade_cost_down.lvl int 1 run scoreboard players get #material_regen_upgrade_cost_down_lvl crystal_shop
