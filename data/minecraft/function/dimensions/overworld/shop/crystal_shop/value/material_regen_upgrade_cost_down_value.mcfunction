# 현재 material_regen_upgrade_cost_down 상점 업그레이드 value 값을 반환

function trial/possibility/effective_level/mat_regen_cost
...
return run data get storage data tmp.crystal_shop.material_regen_upgrade_cost_down.now.value