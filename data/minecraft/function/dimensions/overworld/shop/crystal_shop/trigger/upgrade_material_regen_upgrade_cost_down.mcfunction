execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_crystal_material_regen_cost trial matches 1 run function trial/creation/lost
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_crystal_material_regen_cost trial matches 1 run return 0
...
execute if score #trial_active trial matches 1 if score #trial_id trial matches 4 if score #material_regen_upgrade_cost_down_upgrade_cost_check tmp matches 1 run function trial/possibility/on_upgrade {id:12}
