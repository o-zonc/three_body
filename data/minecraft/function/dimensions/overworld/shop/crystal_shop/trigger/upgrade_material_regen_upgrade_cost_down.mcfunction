...
execute store result score #material_regen_upgrade_cost_down_upgrade_cost_check tmp run function resource/check_cost

execute if score #material_regen_upgrade_cost_down_upgrade_cost_check tmp matches 1 run function resource/take_upgrade_cost
