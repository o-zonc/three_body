...
execute store result score #cave_material_regen_speed_up_upgrade_cost_check tmp run function resource/check_cost

execute if score #cave_material_regen_speed_up_upgrade_cost_check tmp matches 1 run function resource/take_upgrade_cost
