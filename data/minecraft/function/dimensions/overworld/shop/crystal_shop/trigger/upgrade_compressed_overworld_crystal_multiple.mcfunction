...
execute store result score #compressed_overworld_crystal_multiple_upgrade_cost_check tmp run function resource/check_cost

execute if score #compressed_overworld_crystal_multiple_upgrade_cost_check tmp matches 1 run function resource/take_upgrade_cost
