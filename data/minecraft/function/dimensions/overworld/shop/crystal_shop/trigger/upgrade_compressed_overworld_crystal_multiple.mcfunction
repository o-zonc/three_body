execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_crystal_overworld_crystal trial matches 1 run function trial/creation/lost
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_crystal_overworld_crystal trial matches 1 run return 0
...
execute if score #trial_active trial matches 1 if score #trial_id trial matches 4 if score #compressed_overworld_crystal_multiple_upgrade_cost_check tmp matches 1 run function trial/possibility/on_upgrade {id:14}
