...
# 색채 자원 변환 (184X)
execute if score @s shop_trigger matches 1841 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"copper",target_name:"구리",target_color:"gold",base:300,amount:1}
execute if score @s shop_trigger matches 1842 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"gold",target_name:"금",target_color:"gold",base:30,amount:1}
...
execute if score @s shop_trigger matches 1844 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"iron",target_name:"철",target_color:"white",base:200,amount:1}
execute if score @s shop_trigger matches 1845 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"diamond",target_name:"다이아몬드",target_color:"aqua",base:25,amount:1}
...
execute if score @s shop_trigger matches 1847 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"emerald",target_name:"에메랄드",target_color:"green",base:40,amount:1}
execute if score @s shop_trigger matches 1848 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"lapis",target_name:"청금석",target_color:"blue",base:40,amount:1}

execute if score @s shop_trigger matches 1851 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"copper",target_name:"구리",target_color:"gold",base:300,amount:10}
execute if score @s shop_trigger matches 1852 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"gold",target_name:"금",target_color:"gold",base:30,amount:10}
...
execute if score @s shop_trigger matches 1854 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"iron",target_name:"철",target_color:"white",base:200,amount:10}
execute if score @s shop_trigger matches 1855 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"diamond",target_name:"다이아몬드",target_color:"aqua",base:25,amount:10}
...
execute if score @s shop_trigger matches 1857 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"emerald",target_name:"에메랄드",target_color:"green",base:40,amount:10}
execute if score @s shop_trigger matches 1858 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"lapis",target_name:"청금석",target_color:"blue",base:40,amount:10}

execute if score @s shop_trigger matches 1861 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"copper",target_name:"구리",target_color:"gold",base:300,amount:0}
execute if score @s shop_trigger matches 1862 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"gold",target_name:"금",target_color:"gold",base:30,amount:0}
...
execute if score @s shop_trigger matches 1864 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"iron",target_name:"철",target_color:"white",base:200,amount:0}
execute if score @s shop_trigger matches 1865 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"diamond",target_name:"다이아몬드",target_color:"aqua",base:25,amount:0}
...
execute if score @s shop_trigger matches 1867 run function shop/color/convert {source:"yellow",source_name:"노랑",source_color:"yellow",target:"emerald",target_name:"에메랄드",target_color:"green",base:40,amount:0}
execute if score @s shop_trigger matches 1868 run function shop/color/convert {source:"blue",source_name:"파랑",source_color:"blue",target:"lapis",target_name:"청금석",target_color:"blue",base:40,amount:0}
