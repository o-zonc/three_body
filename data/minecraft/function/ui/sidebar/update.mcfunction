...
scoreboard players display name era material_display {"text":"현재 시대: 목기 시대","color":"gold","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 2 run scoreboard players display name era material_display {"text":"현재 시대: 석기 시대","color":"gray","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 3 run scoreboard players display name era material_display {"text":"현재 시대: 청동기 시대","color":"#C87941","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 4 run scoreboard players display name era material_display {"text":"현재 시대: 철기 시대","color":"white","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 5 run scoreboard players display name era material_display {"text":"현재 시대: 고대","color":"aqua","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 6 run scoreboard players display name era material_display {"text":"현재 시대: 중세","color":"green","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 7 run scoreboard players display name era material_display {"text":"현재 시대: 근대","color":"#71CDF9","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 8 run scoreboard players display name era material_display {"text":"현재 시대: 현대","color":"light_purple","bold":true,"shadow_color":-16777216}
execute if score #overworld civilization_age matches 9.. run scoreboard players display name era material_display {"text":"현재 시대: 미래","color":"dark_purple","bold":true,"shadow_color":-16777216}
scoreboard players display name divider material_display {"text":"──────────","color":"dark_gray","shadow_color":-16777216}
