# 미로 최초 진입: 해금 상태는 유지하고 입구를 닫은 뒤 일회용 탈출장치를 지급한다.
...
execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar {text:"긴급탈출장치가 지급되었습니다.",color:"aqua",italic:false}
