# 가루눈의 최대 빙결 시간과 같은 140틱까지 실외 노출도를 누적합니다.
...
# 메마른 세계의 화염 연출처럼 노출된 본인 주변에만 눈 입자를 표시합니다.
# 단계별 count는 1 / 2 / 4 / 7로 제한해 매 tick 파티클 부하를 낮춥니다.
...
# 완전 빙결 중에는 vanilla freezing 피해 유형으로 주기적인 피해를 줍니다.
