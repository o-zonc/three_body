...
function item/give/to_inventory {item:'minecraft:potion[minecraft:custom_name={text:\'보온 물약\',color:\'aqua\',italic:false},minecraft:lore=[{text:\'얼어붙은 세계의 난세기 한파를 견딜 수 있게 해줍니다.\',color:\'gray\',italic:false},{text:\'현재 난세기 동안 채굴 속도 감소 무효\',color:\'dark_aqua\',italic:false}],minecraft:potion_contents={custom_color:5636095},minecraft:custom_data={frozen_chaos_potion:1b}]',amount:1}
