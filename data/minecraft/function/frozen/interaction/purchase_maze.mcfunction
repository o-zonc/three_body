...
execute unless entity @a[tag=accelerator_experiment_running] unless score #frozen_bridge unlock matches 1.. run title @s actionbar {text:"다리를 먼저 해금해야 합니다.",color:"red",italic:true}
...
# 공통 자원 수급과 극한 자원 수급이 모두 2레벨일 때 각각 약 10회 수급분이다.
