...
execute unless score #frozen_bridge unlock matches 1.. run title @s actionbar {text:"다리를 먼저 해금해야 합니다.",color:"red",italic:true}
...
execute unless score #frozen_purchase_check tmp matches 1 run title @s actionbar {text:"다이아몬드 또는 냉기가 부족합니다.",color:"red",italic:true}
