...
execute unless entity @a[tag=accelerator_experiment_running] unless score #frozen_purchase_check tmp matches 1 run title @s actionbar {text:"필요한 재료가 부족합니다.",color:"red",italic:true}
