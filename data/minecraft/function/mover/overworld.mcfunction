...
execute unless entity @s[nbt={Dimension:"minecraft:polarnight"}] unless entity @s[nbt={Dimension:"minecraft:overworld"}] run clear @s minecraft:green_dye[minecraft:custom_data~{overworld_move:1b}] 1
