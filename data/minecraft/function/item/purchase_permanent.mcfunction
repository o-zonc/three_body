...
$execute if score #$(id)_mover unlock matches 1.. run title @s actionbar "§e이미 영구 구매한 아이템입니다."
...
execute if score #item_purchase_cost_check tmp matches 1 run title @s actionbar "§a아이템을 영구 구매했습니다."
