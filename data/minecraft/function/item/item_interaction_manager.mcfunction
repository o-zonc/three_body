...
execute if entity @s[type=interaction,tag=item,tag=cosmos] on target if entity @s[tag=ending_seen] run function item/ui/interact_permanent {id:"cosmos",name:"우주 이동기",color:"dark_aqua",description:"우주로 이동합니다.",trigger:2107}
