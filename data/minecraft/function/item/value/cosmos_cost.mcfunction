data modify storage data tmp.cost set value [{type:"emerald",amount:100},{type:"stone",amount:50},{type:"yellow",amount:10},{type:"blue",amount:10},{type:"world_eye",amount:3}]
