...
execute unless entity @a[tag=accelerator_experiment_running] if score #item_purchase_cost_check tmp matches 1 run title @s actionbar {text:"아이템을 구매했습니다.",color:"green",italic:false}
