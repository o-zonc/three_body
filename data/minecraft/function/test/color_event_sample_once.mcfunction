...
execute unless score #color_sample_count tmp matches 1 if score #color_event_sample tmp != #color_sample_first tmp run scoreboard players set #color_sample_varies tmp 1
