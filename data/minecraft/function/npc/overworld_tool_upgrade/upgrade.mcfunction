execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_tool trial matches 1 run function trial/creation/lost
