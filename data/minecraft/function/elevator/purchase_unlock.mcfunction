# 근대 시대부터 구매 가능: 엘리베이터 Lv. 1 (돌 1,000, 구리 100, 철 50)
...
data modify storage data tmp.cost set value [{type:"stone",amount:1000},{type:"copper",amount:100},{type:"iron",amount:50}]
