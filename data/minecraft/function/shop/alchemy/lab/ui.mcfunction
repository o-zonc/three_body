...
execute unless score #alchemy_workshop unlock matches 1 as @a at @s run playsound ui.button.click master @s ~ ~ ~ 1 2
...
execute unless score #level alchemy_workshop matches 1.. as @a at @s run playsound ui.button.click master @s ~ ~ ~ 1 2
