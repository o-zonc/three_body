# Lv.2 자동 세공 ON/OFF
execute unless score #level alchemy_workshop matches 2.. run title @s actionbar {"text":"자동 세공은 연금술 공방 Lv. 2에서 해금됩니다.","color":"red"}
...
execute if score #jewel_auto_enabled var matches 1 run title @s actionbar {"text":"자동 세공을 시작합니다.","color":"green"}
execute unless score #jewel_auto_enabled var matches 1 run title @s actionbar {"text":"자동 세공을 중지합니다.","color":"gray"}
