...
give @s minecraft:potion[minecraft:custom_name={text:"난세기 종료 물약",color:"light_purple",italic:false},minecraft:lore=[{text:"물약 - 마시기로 사용",color:"blue",italic:false},{text:""},{text:"현재 세계의 난세기를 즉시 종료합니다.",color:"gray",italic:false},{text:"소지 중에는 차원 이동기를 사용할 수 없습니다.",color:"red",italic:false}],minecraft:potion_contents={custom_color:11894492},minecraft:custom_data={chaos_end_potion:1b}] 1
