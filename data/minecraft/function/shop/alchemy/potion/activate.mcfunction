# 카탈리스트 활성화
# 매크로 인수: level, multiplier, duration, roman, break_speed
...
$execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar [{text:"",italic:false},{text:"카탈리스트 $(roman) 활성화",color:"gold",bold:true},{text:"  채굴 자원 ×$(multiplier)",color:"yellow",bold:false},{text:"  채굴 속도 ×$(break_speed)",color:"aqua",bold:false},{text:"  신속 III",color:"green",bold:false}]
return 1
