# 카탈리스트는 구매 후 6분 동안 다시 연성할 수 없습니다.
...
execute if score #level alchemy_workshop matches 0 run title @s actionbar {text:"카탈리스트 I를 양조했습니다.",color:"gold",italic:false}
execute if score #level alchemy_workshop matches 1 run title @s actionbar {text:"카탈리스트 II를 양조했습니다.",color:"gold",italic:false}
execute if score #level alchemy_workshop matches 2.. run title @s actionbar {text:"카탈리스트 III를 양조했습니다.",color:"gold",italic:false}
return 1
