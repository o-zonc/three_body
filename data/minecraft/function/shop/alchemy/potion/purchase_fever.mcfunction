...
execute if score #level alchemy_workshop matches 0 run give @s minecraft:potion[minecraft:item_model="minecraft:potion",minecraft:custom_name={text:"카탈리스트 I",color:"gold",italic:false},minecraft:lore=[{text:"물약 - 마시기로 사용",color:"blue",italic:false},{text:""},{text:"등급: I",color:"gold",italic:false},{text:"채굴 자원 획득량 ×2",color:"yellow",italic:false},{text:"지속 시간: 1분",color:"gray",italic:false}],minecraft:potion_contents={custom_color:16773494},minecraft:custom_data={alchemy_fever_potion:1b,catalyst_level:1b}] 1
execute if score #level alchemy_workshop matches 1 run give @s minecraft:potion[minecraft:item_model="minecraft:potion",minecraft:custom_name={text:"카탈리스트 II",color:"gold",italic:false},minecraft:lore=[{text:"물약 - 마시기로 사용",color:"blue",italic:false},{text:""},{text:"등급: II",color:"gold",italic:false},{text:"채굴 자원 획득량 ×3",color:"yellow",italic:false},{text:"지속 시간: 1분 30초",color:"gray",italic:false}],minecraft:potion_contents={custom_color:15521297},minecraft:custom_data={alchemy_fever_potion:1b,catalyst_level:2b}] 1
execute if score #level alchemy_workshop matches 2.. run give @s minecraft:potion[minecraft:item_model="minecraft:potion",minecraft:custom_name={text:"카탈리스트 III",color:"gold",italic:false},minecraft:lore=[{text:"물약 - 마시기로 사용",color:"blue",italic:false},{text:""},{text:"등급: III",color:"gold",italic:false},{text:"채굴 자원 획득량 ×5",color:"yellow",italic:false},{text:"지속 시간: 2분",color:"gray",italic:false}],minecraft:potion_contents={custom_color:16096779},minecraft:custom_data={alchemy_fever_potion:1b,catalyst_level:3b}] 1
