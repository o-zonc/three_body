...
execute if score #catalyst_cooldown var matches 1.. unless score #GLOBAL era_paused matches 1 run tellraw @s ["",{text:"  다음 구매까지: ",color:"dark_gray"},{score:{name:"#catalyst_cd_minutes",objective:"tmp"},color:"gold"},{text:"분 ",color:"gray"},{score:{name:"#catalyst_cd_remainder",objective:"tmp"},color:"gold"},{text:"초",color:"gray"}]
execute if score #catalyst_cooldown var matches 1.. if score #GLOBAL era_paused matches 1 run tellraw @s ["",{text:"  다음 구매까지: ",color:"dark_gray"},{score:{name:"#catalyst_cd_minutes",objective:"tmp"},color:"gold"},{text:"분 ",color:"gray"},{score:{name:"#catalyst_cd_remainder",objective:"tmp"},color:"gold"},{text:"초 ",color:"gray"},{text:"(시간 정지로 인해 정지됨)",color:"red",italic:true}]
