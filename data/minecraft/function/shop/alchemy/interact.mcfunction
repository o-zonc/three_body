...
execute if score #alchemy_stage tmp matches 1 run data modify storage data tmp.alchemy_shop.next set value {text:"Lv. 1 — 상점/공방 이동기 제작, 세공 작업대 업그레이드, 보석·금속 연성 및 마법 연구소 개방",color:"yellow"}
