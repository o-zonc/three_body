...
$execute unless score #$(source) material >= #color_conversion_source_amount tmp run title @s actionbar [{text:"",italic:true},{text:"$(source_name) 자원이 부족합니다. ",color:"red",bold:false},{text:"필요: ",color:"red",bold:false},{score:{name:"#color_conversion_source_amount",objective:"tmp"},color:"red",bold:false},{text:"개",color:"red",bold:false}]
