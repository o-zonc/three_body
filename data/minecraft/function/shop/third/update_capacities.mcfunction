...
execute if score #information_capacity_bonus meta matches 1.. run scoreboard players add #information_capacity meta 20000
...
execute if score #time_capacity_bonus meta matches 1.. run scoreboard players add #time_capacity meta 10000
