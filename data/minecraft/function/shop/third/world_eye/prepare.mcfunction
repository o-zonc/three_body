...
execute if score #third_eye_lvl tmp matches 1 run data modify storage data tmp.cost set value [{type:"information",amount:192},{type:"time",amount:48},{type:"world_eye",amount:96}]
