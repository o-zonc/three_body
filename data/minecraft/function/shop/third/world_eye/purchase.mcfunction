...
execute unless score #third_eye_lvl tmp matches ..2 run title @s actionbar {text:"이미 최대 단계입니다.",color:"red",italic:true}
...
execute unless score #third_eye_cost_check tmp matches 1 run title @s actionbar {text:"재료가 부족합니다.",color:"red",italic:true}
