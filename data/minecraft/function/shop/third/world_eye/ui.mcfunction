...
execute if score #third_eye_lvl tmp matches ..2 run data modify storage data tmp.third_eye.next set value {text:"\n  다음 단계 연성량: ",color:"gray",extra:[{score:{name:"#third_eye_next_yield",objective:"tmp"},color:"dark_green"},{text:"개",color:"gray"}]}
...
function util/blank
tellraw @s ["",{text:"  [ 세계의 눈 상점 ]",color:"dark_green",bold:true},{text:"\n\n  강화 단계: ",color:"gray"},{score:{name:"#third_eye_lvl",objective:"tmp"},color:"white"},{text:" / 3",color:"gray"},{text:"\n  세계의 눈 보유량: ",color:"gray"},{score:{name:"#world_eye",objective:"material"},color:"dark_green"},{text:"개",color:"gray"},{text:"\n\n  연성 비용: 정보 3조각, 시간 1조각",color:"gray"},{text:"\n  1회 연성량: ",color:"gray"},{score:{name:"#third_eye_yield",objective:"tmp"},color:"green"},{text:"개",color:"gray"},{storage:"data",nbt:"tmp.third_eye.next",interpret:true},{text:"\n\n  "},{text:"[ 세계의 눈 연성 ]",color:"green",bold:true,hover_event:{action:"show_text",value:{text:"§d정보 3조각§r과 §3시간 1조각§r을 소모합니다.",color:"gray"}},click_event:{action:"run_command",command:"/trigger shop_trigger set 1824"}},{text:"   "},{storage:"data",nbt:"tmp.third_eye.button",interpret:true},{text:"\n"}]
