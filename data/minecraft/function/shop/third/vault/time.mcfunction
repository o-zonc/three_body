# 시간 보관 효과는 제목 한 줄만 표시하고, 모든 임계치와 보관 효과는 툴팁에 넣는다.
...
tellraw @s [{text:"  [ 시간 보관 효과 ]",color:"dark_aqua",bold:true,hover_event:{action:"show_text",value:{storage:"data",nbt:"tmp.vault.time_tooltip",interpret:true}}},{text:"\n"}]
