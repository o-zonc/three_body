...
execute if score #time_spacetime_expansion_used var matches 1 run title @s actionbar {text:"이번 극야에서는 이미 시간 보관소의 시공간 확장을 사용했습니다.",color:"red"}
execute if score #time_spacetime_expansion_used var matches 1 run return 0
...
scoreboard players set #time_spacetime_expansion_used var 1
...
advancement grant @s only 3_polarnight/01_storage_time
