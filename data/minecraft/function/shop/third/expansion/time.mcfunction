...
execute unless entity @a[tag=accelerator_experiment_running] unless score #spacetime_expansion_cost_check tmp matches 1 run title @s actionbar {text:"정보 2조각이 필요합니다.",color:"red",italic:true}
