...
execute if score #information_spacetime_expansion_used var matches 1 run data modify storage data tmp.third_shop.expansion_line set value {text:"\n\n  ",extra:[{text:"[ 시공간 확장 완료 ]",color:"dark_gray",bold:true}]}
execute unless score #information_spacetime_expansion_used var matches 1 unless score #GLOBAL reckoning_ready matches 1.. run data modify storage data tmp.third_shop.expansion_line set value {text:"\n\n  ",extra:[{text:"[ 시공간 확장 종료 ]",color:"dark_gray",bold:true}]}
