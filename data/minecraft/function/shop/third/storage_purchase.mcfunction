...
execute unless score #third_lvl tmp matches ..2 run title @s actionbar "§c이미 최대 단계입니다."
...
execute unless score #third_cost_check tmp matches 1 run title @s actionbar "§c재료가 부족합니다."
