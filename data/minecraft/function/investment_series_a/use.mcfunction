...
execute unless dimension minecraft:overworld run title @s actionbar {"text":"천공의 제단 곁에서만 투자금을 수령할 수 있습니다.","color":"red","italic":true}
execute unless dimension minecraft:overworld run return 0
execute positioned 0 -59 0 unless entity @s[distance=..3.0] run title @s actionbar {"text":"천공의 제단 곁에서만 투자금을 수령할 수 있습니다.","color":"red","italic":true}
