...
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_obsidian_production trial matches 1 run setblock -17 1 5 air replace
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_obsidian_production trial matches 1 run scoreboard players set #obsidian_present generate 0
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_obsidian_production trial matches 1 run scoreboard players reset #obsidian_remain generate
...
execute if score #obsidian_present generate matches 1 unless score #obsidian_full tmp matches 1 run function product/overworld/obsidian/regen/break
...
execute if score #obsidian_regen_initialized tmp matches 1 store result score #obsidian_remain generate run function product/overworld/obsidian/value/regen_value
scoreboard players reset #obsidian_regen_initialized tmp

# 쿨다운이 전부 다 돌면 흑요석 설치
execute if score #obsidian_remain generate matches ..0 run function product/overworld/obsidian/regen/place
