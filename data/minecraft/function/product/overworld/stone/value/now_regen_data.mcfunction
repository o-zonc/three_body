# data 저장소의 tmp.regen_data.now 경로에 const.product.stone.regen[{lvl:(현재 레벨)}] 값을 삽입
...
function product/overworld/stone/value/regen_data_by_lvl with storage data tmp.regen_data
