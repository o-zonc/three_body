...
execute store result score #mob_remain generate run function product/overworld/mob/value/regen_value
...
particle minecraft:dust{color:16777215,scale:1f} 3.5 1.5 4.5 0.5 0.5 0.5 0 30 force @a[tag=player]
