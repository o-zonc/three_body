...
function product/overworld/wood/value/regen_upgrade_cost
...
# 업그레이드 재료 소지 여부 확인
execute store result score #wood_regen_upgrade_cost_check tmp run function product/check_cost

# 소지 시 업그레이드
execute if score #wood_regen_upgrade_cost_check tmp matches 1 run function product/take_upgrade_cost
...
execute if score #wood_regen_upgrade_cost_check tmp matches 1 as @a[tag=player] run function product/overworld/wood/ui/info
