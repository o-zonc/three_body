execute store result score #wood_restore_cooldown tmp run function product/overworld/wood/value/regen_value
...
function product/convert_upgrade_cost_to_text_named {id:"wood_regen",insertion:", "}
