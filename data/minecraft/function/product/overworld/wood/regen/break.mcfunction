...
# 나무 재생산 대기시간 시작
execute store result score #wood_remain generate run function product/overworld/wood/value/regen_value



# 돌 해금 시 돌 재생산 카운트
execute if score #stone unlock matches 1 run function product/overworld/wood/regen/stone_count
