execute store result score #coal_restore_cooldown tmp run function product/overworld/coal/value/regen_value
...
execute if score #trial_active trial matches 1 if score #trial_id trial matches 5 unless score #creation_available_coal_production trial matches 1 run data modify storage data tmp.coal_restore_component set value {text:"[ 손실됨 ]",color:"dark_gray",shadow_color:-1428043265,bold:true,hover_event:{action:"show_text",value:{text:"그것은 손실되었습니다.",color:"dark_gray",shadow_color:-1428043265,bold:true}}}
