...
execute if block -47 1 4 air unless score #quartz_present generate matches 1 run function product/nether/quartz/regen/place
execute if block -47 1 4 air unless score #quartz_remain generate = #quartz_remain generate run function product/nether/quartz/regen/break
execute if block -47 1 4 air if score #quartz_remain generate matches ..0 run function product/nether/quartz/regen/place
