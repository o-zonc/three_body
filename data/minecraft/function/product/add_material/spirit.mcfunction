...
scoreboard players operation #material_add_limit tmp -= #spirit material
execute if score #material_add_limit tmp matches ..0 run scoreboard players operation #spirit material = #material_max tmp
...
scoreboard players operation #spirit material += #material_add_value tmp