...
# 1. 얼음 차원 (frozen)
# ==========================================
execute if score #GLOBAL current_dim matches 2 unless score #frozen_maze_active var matches 1 if score #GLOBAL era_paused matches 0 if score #GLOBAL timer_frozen matches 1.. run scoreboard players remove #GLOBAL timer_frozen 1
execute if score #GLOBAL current_dim matches 2 unless score #frozen_maze_active var matches 1 if score #GLOBAL era_paused matches 0 if score #GLOBAL timer_frozen matches ..0 run function common/roll/frozen
execute if score #GLOBAL current_dim matches 2 unless score #frozen_maze_active var matches 1 if score #GLOBAL era_paused matches 0 as @a[tag=player] at @s run function common/chaos/frozen
...
# 4. 멸망 (disaster)
# ==========================================
execute if score #GLOBAL current_dim matches 2 unless score #frozen_maze_active var matches 1 if score #GLOBAL era_paused matches 0 if score #GLOBAL state_frozen matches 2 run scoreboard players set #GLOBAL user_disaster 0
execute if score #GLOBAL current_dim matches 2 unless score #frozen_maze_active var matches 1 if score #GLOBAL era_paused matches 0 if score #GLOBAL state_frozen matches 2 as @a[tag=player,limit=1] at @s run function common/disaster/do
