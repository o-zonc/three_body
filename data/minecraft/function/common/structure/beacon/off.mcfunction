execute unless score #structure_apply_context var matches 1 run scoreboard players set #structure_trigger var 2010
...
execute in overworld run data modify block 18 -64 -30 name set value "air"
