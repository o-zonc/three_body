...
execute unless score #structure_loaded tmp matches 9 run schedule function minecraft:common/structure/beacon/on 1t replace
execute unless score #structure_loaded tmp matches 9 run return 0

#비콘 활성화
execute in overworld run data modify block 18 -64 -30 name set value "common:beacon"
