...
execute if score #GLOBAL current_dim matches 0 if score #GLOBAL first_frozen matches 0 if score #GLOBAL first_dried matches 0 run advancement grant @a only 6_disaster/11_early_overworld
