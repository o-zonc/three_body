...
execute in overworld unless score #gold factory_unlocked matches 1 if block 0 -58 0 #campfires run setblock 0 -58 0 air
...
execute in overworld if score #gold factory_unlocked matches 1 if score #gold factory_enabled matches 1 run setblock 0 -58 0 campfire[lit=true]
execute in overworld if score #gold factory_unlocked matches 1 unless score #gold factory_enabled matches 1 run setblock 0 -58 0 campfire[lit=false]
