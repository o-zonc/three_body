...
$execute unless entity @a[tag=accelerator_experiment_running] unless score #$(id) factory_unlocked matches 1 run title @s actionbar {text:"공장을 먼저 해금해야 합니다.",color:"red",italic:true}
