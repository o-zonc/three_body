...
execute if score #factory_recycle_level upgrade matches 1 run data modify storage data tmp.cost set value [{type:"iron",amount:700000},{type:"gold",amount:100000}]
execute if score #factory_recycle_level upgrade matches 2 run data modify storage data tmp.cost set value [{type:"iron",amount:2000000},{type:"coal",amount:1700000},{type:"gold",amount:300000},{type:"information",amount:8}]
execute if score #factory_recycle_level upgrade matches 3 run data modify storage data tmp.cost set value [{type:"iron",amount:7000000},{type:"gold",amount:1200000},{type:"diamond",amount:500000},{type:"information",amount:20},{type:"time",amount:4}]
