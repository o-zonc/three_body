...
function util/blank
tellraw @s ["",{text:"  [ 산업 연구 · 재처리 기술 ]",color:"green",bold:true},{text:"\n\n  대규모 산업 시설에 투입된 물질 자원의 일부를 회수합니다.",color:"gray",bold:false},{text:"\n  • 연구 단계: ",color:"gray"},{score:{name:"#factory_recycle_level",objective:"upgrade"},color:"white"},{text:" / 4",color:"gray"},{text:"\n  • 현재 회수율: ",color:"gray"},{score:{name:"#factory_recycle_rate",objective:"tmp"},color:"green"},{text:"%",color:"green"},{text:"\n\n  Lv.1  공장 건설·업그레이드 비용 10% 환급",color:"dark_gray"},{text:"\n  Lv.2  입자가속기 가동·업그레이드 비용 20% 환급",color:"dark_gray"},{text:"\n  Lv.3  입자가속기 실험 비용 30% 환급",color:"dark_gray"},{text:"\n  Lv.4  타임머신 연구 비용 40% 환급",color:"dark_gray"},{text:"\n\n  "},{storage:"data",nbt:"tmp.factory_recycle.button",interpret:true},{text:"\n"}]
