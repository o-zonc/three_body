...
execute unless entity @a[tag=accelerator_experiment_running] as @a[tag=player,limit=1] run title @s actionbar {text:"입자가속기의 자동 수리가 완료되었습니다.",color:"green",italic:false}
