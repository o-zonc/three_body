...
# 자원 상점과 생산 업그레이드
execute if score #information_bank meta matches 10.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 1층 자원 상점 진행\n",color:"gray",strikethrough:true}
execute unless score #information_bank meta matches 10.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 1층 자원 상점 진행\n",color:"gray"}
...
execute if score #information_bank meta matches 200.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 기질 자원 해금 상태\n",color:"gray",strikethrough:true}
execute unless score #information_bank meta matches 200.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 기질 자원 해금 상태\n",color:"gray"}
...
execute if score #information_bank meta matches 125.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 연금술 공방 및 세공 연구\n",color:"gray",strikethrough:true}
execute unless score #information_bank meta matches 125.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 연금술 공방 및 세공 연구\n",color:"gray"}
...
# 메마른·얼어붙은 차원 진행
execute if score #information_bank meta matches 75.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 메마른 유물 복원 단계\n",color:"gray",strikethrough:true}
execute unless score #information_bank meta matches 75.. run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 메마른 유물 복원 단계\n",color:"gray"}
...
execute if entity @a[advancements={0_overworld/22_heavy_ion_experiment=true}] run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 노랑·파랑 자원 해금\n",color:"gray",strikethrough:true}
execute unless entity @a[advancements={0_overworld/22_heavy_ion_experiment=true}] run data modify storage data tmp.reckoning_reset_tooltip append value {text:"• 노랑·파랑 자원 해금\n",color:"gray"}

data modify storage data tmp.reckoning_reset_tooltip append value {text:"\n취소선이 표시된 항목은 현재 보관소 효과 또는 발전과제로 유지됩니다.",color:"green"}
