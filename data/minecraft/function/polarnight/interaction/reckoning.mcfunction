...
tellraw @s ["",{text:"  [ 문명 정산대 ]",color:"dark_aqua",bold:true},{text:"\n\n  지금까지의 문명을 정산하고 다음 순환을 준비합니다.",color:"gray"},{text:"\n\n  • 정보 보관소: ",color:"gray",bold:false},{score:{name:"#information_bank",objective:"meta"},color:"light_purple"},{text:"조각",color:"gray"},{text:"\n  • 시간 보관소: ",color:"gray"},{score:{name:"#time_bank",objective:"meta"},color:"dark_aqua"},{text:"조각",color:"gray"},{text:"\n\n  [ 정산 보상 ]",color:"aqua",bold:true,hover_event:{action:"show_text",value:[{text:"정보",color:"light_purple"},{text:" · 이번 문명의 시설과 기술 발전 정도에 따라 증가합니다.\n",color:"gray"},{text:"시간",color:"dark_aqua"},{text:" · 이번 문명이 도달한 시대가 높을수록 증가합니다.",color:"gray"}]}},{text:"\n  • 이번 정산에서 얻을 보상: ",color:"gray",bold:false},{text:"정보 ",color:"light_purple"},{score:{name:"#reckoning_information_reward",objective:"tmp"},color:"light_purple"},{text:"조각",color:"light_purple"},{text:" · ",color:"dark_gray"},{text:"시간 ",color:"dark_aqua"},{score:{name:"#reckoning_time_reward",objective:"tmp"},color:"dark_aqua"},{text:"조각",color:"dark_aqua"},{text:" · ",color:"dark_gray"},{text:"깨달음",color:"#9EF971"},{text:"\n\n  "},{text:"[ 초기화되는 항목 ]",color:"red",bold:true,hover_event:{action:"show_text",value:{storage:"data",nbt:"tmp.reckoning_reset_tooltip",interpret:true}}},{text:"\n  발전과제 보상, 정보·시간 보관소, 영구 보존 대상은 유지됩니다.",color:"green",bold:false},{text:"\n\n  "},{text:"[ 문명 정산 ]",color:"aqua",bold:true,hover_event:{action:"show_text",value:[{text:"문명의 현재 진행도를 정산합니다.\n이 작업은 이번 극야 진입에서 ",color:"gray"},{text:"한 번만 ",color:"red"},{text:"실행할 수 있습니다.",color:"gray"}]},click_event:{action:"run_command",command:"/trigger shop_trigger set 2101"}},{text:"\n"}]
