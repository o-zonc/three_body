...
function meta/sync
title @s actionbar [{text:"",italic:false},{text:"흑요석 +",color:"dark_gray",shadow_color:-8388480},{score:{name:"#material_add_value",objective:"tmp"},color:"dark_gray",shadow_color:-8388480}]
return 1
