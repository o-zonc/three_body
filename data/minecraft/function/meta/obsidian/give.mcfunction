...
# 흑요석은 보관소 없이 전량 인벤토리 아이템으로 지급한다.
...
function meta/sync
execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar [{text:"",italic:false},{text:"흑요석 +",color:"dark_gray",shadow_color:-8388480},{score:{name:"#material_add_value",objective:"tmp"},color:"dark_gray",shadow_color:-8388480}]
return 1
