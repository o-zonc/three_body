...
# 초록 발전 트리 완성 보상: 모든 시간 획득량을 2배로 적용한다.
...
execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar [{text:"",italic:false},{text:"시간 +",color:"dark_aqua"},{score:{name:"#meta_requested",objective:"tmp"},color:"dark_aqua"},{text:"  (소지 +",color:"dark_gray"},{score:{name:"#meta_to_wallet",objective:"tmp"},color:"dark_aqua"},{text:" / 보관 +",color:"dark_gray"},{score:{name:"#meta_bank_added",objective:"tmp"},color:"dark_aqua"},{text:")",color:"dark_gray"}]
return 1
