...
execute unless entity @a[tag=accelerator_experiment_running] unless dimension minecraft:overworld run title @s actionbar {"text":"천공의 제단 곁에서만 하늘의 은총을 받을 수 있습니다.","color":"red",italic:true}
execute unless dimension minecraft:overworld run return 0
execute unless entity @a[tag=accelerator_experiment_running] positioned 0 -59 0 unless entity @s[distance=..3.0] run title @s actionbar {"text":"천공의 제단 곁에서만 하늘의 은총을 받을 수 있습니다.","color":"red",italic:true}
