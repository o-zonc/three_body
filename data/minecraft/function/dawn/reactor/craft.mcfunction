...
# 세 증폭기 발전과제와 흑요석 저장고는 각각 리액터 산출량을 25%씩 증가시킵니다.
...
# 기본 산출량에 (100 + 발전과제 보상 25 * 달성 수)%를 적용합니다.
