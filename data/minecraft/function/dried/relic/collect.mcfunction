...
execute if score #dried_relic_roll tmp matches 7 run execute as @a[tag=player] run title @s actionbar [{text:"",italic:false},{text:"고대 문명 발굴 장치가 " ,color:"gold"},{text:"에메랄드 자원 ",color:"green"},{score:{name:"#dried_relic_amount",objective:"tmp"},color:"white"},{text:"개를 회수했습니다.",color:"gold"}]
execute if score #dried_relic_roll tmp matches 8 run execute as @a[tag=player] run title @s actionbar [{text:"",italic:false},{text:"고대 문명 발굴 장치가 " ,color:"gold"},{text:"청금석 자원 ",color:"blue"},{score:{name:"#dried_relic_amount",objective:"tmp"},color:"white"},{text:"개를 회수했습니다.",color:"gold"}]
