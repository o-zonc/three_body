...
title @s actionbar [{text:"",italic:false},{text:"재활용하여 ",color:"gray"},{text:"정보 ",color:"light_purple",shadow_color:-8388608},{score:{name:"#recycle_meta_amount",objective:"tmp"},color:"light_purple",shadow_color:-8388608},{text:" 조각",color:"light_purple",shadow_color:-8388608},{text:"을 획득했습니다.",color:"gray"}]
