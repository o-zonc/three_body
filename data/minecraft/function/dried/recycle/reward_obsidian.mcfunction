...
execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar [{text:"",italic:false},{text:"재활용하여 ",color:"gray"},{text:"흑요석 1 개",color:"dark_gray",shadow_color:-8388480},{text:"를 획득했습니다.",color:"gray"}]
