...
execute unless entity @a[tag=accelerator_experiment_running] run title @s actionbar [{text:"",italic:false},{text:"재활용하여 ",color:"gray"},{text:"시간 ",color:"dark_aqua",shadow_color:-16755200},{score:{name:"#recycle_meta_amount",objective:"tmp"},color:"dark_aqua",shadow_color:-16755200},{text:" 조각",color:"dark_aqua",shadow_color:-16755200},{text:"을 획득했습니다.",color:"gray"}]
