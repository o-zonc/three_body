...
give @s minecraft:potion[minecraft:custom_name={text:'냉각 물약',color:'gold',italic:false},minecraft:lore=[{text:'메마른 세계의 난세기 폭염을 견딜 수 있게 해줍니다.',color:'gray',italic:false},{text:'현재 난세기 동안 발화 효과 무효',color:'yellow',italic:false}],minecraft:potion_contents={custom_color:16753920},minecraft:custom_data={dried_chaos_potion:1b}] 1
