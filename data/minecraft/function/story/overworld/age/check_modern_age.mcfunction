# 중세 이후 공방 Lv. 1을 달성하고 구리 700개와 철 400개 이상을 보유하면 근대에 진입한다.
...
execute unless score #copper material matches 700.. run return 0
execute unless score #iron material matches 400.. run return 0
