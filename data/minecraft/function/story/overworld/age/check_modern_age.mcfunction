# 중세 이후 공방 Lv. 1을 달성하고 구리 10,000개와 철 6,000개 이상을 보유하면 근대에 진입한다.
...
execute unless score #copper material matches 10000.. run return 0
execute unless score #iron material matches 6000.. run return 0
